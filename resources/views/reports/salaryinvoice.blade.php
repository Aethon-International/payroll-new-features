                      ...
                      <tr>
                        <td class="border-r pr-4">
                          <div>
                            ...
                            <p class="whitespace-nowrap font-bold text-main text-right">{{ \Carbon\Carbon::now()->format(' F j, Y') }}</p>
                          </div>
                        </td>
                        <!-- <td class="pl-4">
                          <div>
            ...
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600">
                  <p class="font-bold">Aethon INT.</p>
                  <p>Phone Number: (053) 7533033</p>
                  <p>Registration Number: 14275264</p>
                  <p>Aethon House, Sadar, Kharian Cantt, Kharian, Pakistan</p>
                </div>
              </td>
            </tr>
          </tbody>
